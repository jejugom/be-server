...
public class CodefController {
	...
	@ApiOperation(value = "연결된 계좌 정보 조회 및 저장", notes = "사용자의 connectedId를 이용해 CODEF에서 계좌 목록을 조회하고, 그 결과를 서버 DB에 저장합니다.")
	@ApiResponses({
		@ApiResponse(code = 200, message = "조회 및 저장 처리 완료", response = Map.class),
		@ApiResponse(code = 500, message = "서버 오류 (CODEF 조회 실패 또는 DB 저장 실패)")
	})
